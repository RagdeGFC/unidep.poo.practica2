...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (horaActual >= 6 && horaActual < 12) { // 6:00 a 11:59 (Mañana)
            objetoElegido = new Manana();
        } else if (horaActual >= 12 && horaActual < 19) { // 12:00 a 18:59 (Tarde)
            objetoElegido = new Tarde();
        } else { // 19:00 a 5:59 (Noche)
...
class Padre {
    ...
    protected double distancia = 1.5;
